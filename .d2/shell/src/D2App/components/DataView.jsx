...
const DataView = ({ isOpen, onClose, eventData }) => {
  ...
  const getDataValue = (dataElementId) => {
    const dataValue = eventData.dataValues?.find(
      ...
      <Modal position="middle" hide={!isOpen} onClose={handleClose}>
          ...
          <div id="print-area">
            <div className="certificate-container">
              <div className="certificate-header">
                ...
                <h3 style={{ fontSize: "12pt", margin: "10px 0" }}>
              ...
              <table className="certificate-table">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <strong>Mother Nationality:</strong>
                    </td>
                    <td>{renderNationality(motherNationality)}</td>
                  </tr>
                  <tr>
                    <td>
                      <strong>Mother State:</strong>
                    </td>
                    <td>{motherState}</td>
                    <td>
                      <strong>Mother County:</strong>
                    </td>
                    <td>{motherCounty}</td>
                  </tr>
                  <tr>
                    <td>
                      <strong>Mother Payam:</strong>
                    </td>
                    <td>{motherPayam}</td>
                    <td>
                      <strong>Mother Boma:</strong>
                    </td>
                    <td>{motherBoma}</td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      <strong>Father State:</strong>
                    </td>
                    <td>{fatherState}</td>
                    <td>
                      <strong>Father County:</strong>
                    </td>
                    <td>{fatherCounty}</td>
                  </tr>
                  <tr>
                    <td>
                      <strong>Father Payam:</strong>
                    </td>
                    <td>{fatherPayam}</td>
                    <td>
                      <strong>Father Boma:</strong>
                    </td>
                    <td>{fatherBoma}</td>
                  </tr>
              ...
              <div className="certificate-footer">
                This Birth Notification is system-generated and does not require
                a signature.
                <br />
        ...
        <ModalActions>
          <ButtonStrip>
            ...
            <Button onClick={handleClose} destructive>
              Close
            </Button>
          </ButtonStrip>
        </ModalActions>
