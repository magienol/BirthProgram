...
(0, _cypressCucumberPreprocessor.Given)('a sharing dialog with user item with view and edit is visible', () => {
  cy.intercept('GET', '/api/38/sharing?type=visualization&id=id', {
...
(0, _cypressCucumberPreprocessor.Given)('a sharing dialog with group item with view and edit is visible', () => {
  cy.intercept('GET', '/api/38/sharing?type=visualization&id=id', {
...
(0, _cypressCucumberPreprocessor.When)('the user removes the access for the user', () => {
...
(0, _cypressCucumberPreprocessor.When)('the user removes the access for the group', () => {
  cy.intercept('PUT', '/api/38/sharing?type=visualization&id=id', req => {
    const expected = {
