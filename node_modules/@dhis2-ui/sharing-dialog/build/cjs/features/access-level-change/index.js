...
(0, _cypressCucumberPreprocessor.Then)('the all users section should be labeled for all users', () => {
  cy.get('@all-users-list-item').contains('.details-text', 'Anyone logged in').should('be.visible');
});
(0, _cypressCucumberPreprocessor.Then)('the user section should be labeled for user', () => {
  cy.get('@user-list-item').contains('.details-text', 'user-1').should('be.visible');
});
(0, _cypressCucumberPreprocessor.Then)('the group section should be labeled for group', () => {
  cy.get('@group-list-item').contains('.details-text', 'User group').should('be.visible');
});