...
exports.replaceAccessWithConstant = exports.isRemovableTarget = exports.debounce = exports.createOnRemovePayload = exports.createOnChangePayload = exports.createOnAddPayload = exports.convertConstantToAccessString = exports.convertConstantObjectToAccess = exports.convertAccessToConstantObject = void 0;
...
const convertAccessToConstantObject = accessString => {
...
exports.convertAccessToConstantObject = convertAccessToConstantObject;
const convertConstantToAccessString = constant => {
  switch (constant) {
...
exports.convertConstantToAccessString = convertConstantToAccessString;
const convertConstantObjectToAccess = accessObject => {
 ...
 */
exports.convertConstantObjectToAccess = convertConstantObjectToAccess;
