...
const SharingDialog = _ref4 => {
  ...
  const publicAccess = (0, _index2.convertAccessToConstantObject)(object.publicAccess);
...
SharingDialog.propTypes = {
  ...
  cascadeDashboardSharing: _propTypes.default.bool,
  ...
  initialSharingSettings: _propTypes.default.shape({
    ...
    groups: _propTypes.default.objectOf(_propTypes.default.shape({
      ...
      access: _propTypes.default.oneOfType([_propTypes.default.shape({
      ...
      }), _propTypes.default.oneOf([_constants.ACCESS_NONE, _constants.ACCESS_VIEW_ONLY, _constants.ACCESS_VIEW_AND_EDIT])])
    })),
    name: _propTypes.default.string,
    public: _propTypes.default.oneOfType([_propTypes.default.shape({
      data: _propTypes.default.oneOf([_constants.ACCESS_NONE, _constants.ACCESS_VIEW_ONLY, _constants.ACCESS_VIEW_AND_EDIT]),
      metadata: _propTypes.default.oneOf([_constants.ACCESS_NONE, _constants.ACCESS_VIEW_ONLY, _constants.ACCESS_VIEW_AND_EDIT])
    }), _propTypes.default.oneOf([_constants.ACCESS_NONE, _constants.ACCESS_VIEW_ONLY, _constants.ACCESS_VIEW_AND_EDIT])]),
