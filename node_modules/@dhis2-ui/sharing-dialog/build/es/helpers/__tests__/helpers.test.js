...
import { convertAccessToConstantObject, convertConstantObjectToAccess, isRemovableTarget } from '../helpers.js';
describe('helpers', () => {
  describe('convertAccessToConstantObject', () => {
    ...
    it('disallows access if the access string is invalid', () => {
      ...
      expect(convertAccessToConstantObject('invalid-access-string')).toEqual(NO_ACCESS_OBJECT);
    });
    const cases = [['--------', {
      data: ACCESS_NONE,
      metadata: ACCESS_NONE
      ...
      data: ACCESS_NONE,
      metadata: ACCESS_VIEW_ONLY
    }], ['r-r-----', {
      data: ACCESS_VIEW_ONLY,
      metadata: ACCESS_VIEW_ONLY
    }], ['rw------', {
      data: ACCESS_NONE,
  ...
  describe('convertConstantObjectToAccess', () => {
    ...
    it.each(cases)('returns the correct metadata access string for %s', (accessConstant, accessString) => {
      expect(convertConstantObjectToAccess(accessConstant)).toEqual(accessString);
    });
  });
