...
const useDatePicker = _ref => {
  ...
  const navigation = (0, _useNavigation.useNavigation)(firstZdtOfVisibleMonth.withCalendar(localeOptions.calendar), setFirstZdtOfVisibleMonth, {
    ...localeOptions,
    pastOnly: options === null || options === void 0 ? void 0 : options.pastOnly
  });
  ...
  const result = {
    calendarWeekDays: calendarWeekDaysZdts.map(week => week.map(weekDayZdt => ({
      dateValue: (0, _helpers.formatDate)(weekDayZdt, undefined, format),
      label: _localisationHelpers.default.localiseWeekLabel(weekDayZdt.withCalendar(localeOptions.calendar), {
        ...localeOptions,
