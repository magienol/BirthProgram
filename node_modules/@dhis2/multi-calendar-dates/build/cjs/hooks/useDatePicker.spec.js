...
describe('clicking a day', () => {
  ...
  it('should call the callback with correct info for Ethiopic calendar', () => {
    ...
    const calendarDate = (0, _utils.convertToIso8601)(calendarDateString, 'ethiopic');
    expect(calendarDate).toEqual({
      day: 7,
      month: 9,
      year: 2023
    });
  ...
  it('should call the callback with correct info for a custom (Nepali) calendar', () => {
    ...
    expect(_localisationHelpers.default.localiseMonth({
      year: 20777,
      month: 12,
      day: 30
    }, {
...
describe('month labels in useDatePicker hook', () => {
  describe('gregorian months', () => {
    ...
    it('should return localized month labels for Arabic locale', () => {
      ...
      expect(arabicMonths[0]).toEqual({
        value: 1,
        label: 'يناير'
      });
      expect(arabicMonths[11]).toEqual({
        value: 12,
        label: 'ديسمبر'
      });
    });
  ...
  describe('ethiopic months', () => {
    ...
    it('should return localized month labels for Amharic locale', () => {
      ...
      expect(amharicMonths[0]).toEqual({
        value: 1,
        label: 'መስከረም'
      });
      expect(amharicMonths[12]).toEqual({
        value: 13,
        label: 'ጳጉሜን'
      });
    });
  ...
  describe('nepali months', () => {
    ...
    it('should return localized month labels for Nepali locale', () => {
      ...
      expect(nepaliMonths[0]).toEqual({
        value: 1,
        label: 'बैशाख'
      });
      expect(nepaliMonths[11]).toEqual({
        value: 12,
        label: 'चैत'
      });
    });
