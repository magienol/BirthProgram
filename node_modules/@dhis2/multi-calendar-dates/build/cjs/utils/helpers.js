...
exports.padWithZeroes = exports.isCustomCalendar = exports.getMonthsForCalendar = exports.getCustomCalendarIfExists = exports.formatDate = exports.extractAndValidateDateString = exports.capitalize = void 0;
var _months = require("../constants/months");
...
const getMonthsForCalendar = calendarType => {
  return _months.months[calendarType.toLowerCase()] || _months.months.gregory;
};
exports.getMonthsForCalendar = getMonthsForCalendar;