...
describe('validateDateString (gregory)', () => {
  ...
  it('should return an error message for a date with mixed delimiters', () => {
    expect((0, _validateDateString.validateDateString)('2024/02.02').validationText).toBe('Date string is invalid, received "2024&#x2F;02.02"');
  });
  it('should return an error message for a date missing year digits', () => {
    expect((0, _validateDateString.validateDateString)('200.02.02').validationText).toBe('Date string is invalid, received "200.02.02"');
  });
  it('should return an error message for a date missing month digits', () => {
    expect((0, _validateDateString.validateDateString)('2000.2.02').validationText).toBe('Date string is invalid, received "2000.2.02"');
  });
  it('should return an error message for a date missing day digits', () => {
    expect((0, _validateDateString.validateDateString)('2000.02.2').validationText).toBe('Date string is invalid, received "2000.02.2"');
  });
  it('should return an error message when the value is out of range', () => {
    expect((0, _validateDateString.validateDateString)('2025-12-32').validationText).toBe('Invalid date in specified calendar');
  });
