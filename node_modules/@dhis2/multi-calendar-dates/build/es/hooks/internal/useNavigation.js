  ...
  return useMemo(() => {
    ...
    const getYearOptions = function (currentYear) {
      ...
      for (let year = startYear; year <= endYear; year++) {
        ...
        years.push({
          label: localisationHelpers.localiseYear(yearDate, {
            ...localeOptions,
    ...
    options.calendar === 'ethiopic' ? (_firstZdtOfVisibleMon = firstZdtOfVisibleMonth.eraYear) !== null && _firstZdtOfVisibleMon !== void 0 ? _firstZdtOfVisibleMon : String(localisationHelpers.localiseYear(firstZdtOfVisibleMonth, {
      ...localeOptions,
      calendar: options.calendar
    ...
    const months = !isCustom && (_options$locale = options.locale) !== null && _options$locale !== void 0 && _options$locale.toLowerCase().startsWith('en') ? getMonthsForCalendar(options.calendar) : getMonthsForCalendar(isCustom ? 'gregory' : options.calendar).map(month => {
      const calendar = new Temporal.Calendar(isCustom ? 'gregory' : options.calendar);
      ...
      return {
        value: month.value,
        label: localisationHelpers.localiseMonth(date, {
          ...localeOptions,
          calendar: options.calendar
    ...
    return {
      prevYear: {
        label: localisationHelpers.localiseYear(prevYear, {
          ...localeOptions,
          calendar: options.calendar
        }, yearNumericFormat),
      ...
      currYear: {
        label: localisationHelpers.localiseYear(firstZdtOfVisibleMonth, {
          ...localeOptions,
          calendar: options.calendar
        }, yearNumericFormat),
      ...
      nextYear: {
        label: localisationHelpers.localiseYear(nextYear, {
          ...localeOptions,
          calendar: options.calendar
        }, yearNumericFormat),
      ...
      prevMonth: {
        label: localisationHelpers.localiseMonth(prevMonth, {
          ...localeOptions,
          calendar: options.calendar
        }, monthFormat),
      ...
      currMonth: {
        label: localisationHelpers.localiseMonth(firstZdtOfVisibleMonth, {
          ...localeOptions,
          calendar: options.calendar
        }, monthFormat)
      },
      nextMonth: {
        label: localisationHelpers.localiseMonth(nextMonth, {
          ...localeOptions,
          calendar: options.calendar
        }, monthFormat),
